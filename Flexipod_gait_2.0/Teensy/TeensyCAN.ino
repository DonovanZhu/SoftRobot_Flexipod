...
double k_1_trot = (360.0 - CONTACT_ANGLE) / (1.0 - CONTACT_TIME_TROT);
double k_2_trot = CONTACT_ANGLE / CONTACT_TIME_TROT;
double b_1_trot = 360.0 - k_1_trot;
double b_2_trot = (90.0 + 0.5 * CONTACT_ANGLE) - k_2_trot * ((90.0 + 0.5 * CONTACT_ANGLE) - b_1_trot) / k_1_trot;

double k_1_crawl = (360.0 - CONTACT_ANGLE) / (1.0 - CONTACT_TIME_CRAWL);
double k_2_crawl = CONTACT_ANGLE / CONTACT_TIME_CRAWL;
...
double k_1_bound = (360.0 - CONTACT_ANGLE) / (1.0 - CONTACT_TIME_BOUND);
double k_2_bound = CONTACT_ANGLE / CONTACT_TIME_BOUND;
